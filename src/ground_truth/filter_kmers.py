...
with open('/home/groups/dpwall/briannac/alt_haplotypes/data/known_alt_haplotype_kmers.txt') as in_file: #intermediate_files/ground_truth/sample_kmer_counts/known_alt_haplotype_kmers.txt') as in_file:
    i=0
